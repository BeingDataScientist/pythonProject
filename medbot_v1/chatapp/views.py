...
def ProcessData(data):
    ...
    try:
        ...
        ****************
        ...
        with open('/home/omkesh/PycharmProjects/pythonProject/medbot_v1/ScheduleingData.json', 'w') as f:
            json.dump(Jdata, f)
...
def show ( request) :
    ...
    indu=0
    with open('/home/omkesh/PycharmProjects/pythonProject/medbot_v1/ScheduleingData.json', 'r') as jsonfile:
